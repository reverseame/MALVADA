...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Reads each .json report, retrieving the sha256 and the consensus AVClass and CAPE label. Also prints how many reports have no consensus. Generates reports_consensus_label.json.")
